  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      try {
        ...
        centerMat.colorNode = color(0xFF5E1A);
        ...
        haloMat.colorNode = color(0xFF5E1A);
        ...
        for (let i = 0; i < PILLARS; i++) {
          ...
          (m.material as THREE.MeshBasicNodeMaterial).colorNode = color(0xFF5E1A);
