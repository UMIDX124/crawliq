  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `
            radial-gradient(ellipse 60% 50% at 15% 0%, rgb(255 170 0 / 0.06), transparent 60%),
            radial-gradient(ellipse 50% 40% at 100% 100%, rgb(255 170 0 / 0.04), transparent 60%)
          `,
        }}
      />
