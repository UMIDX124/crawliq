  ...
  return (
    <article
      ...
      className={cn(
        ...
        plan.featured
          ? "border border-[color:var(--color-accent)] bg-[color:var(--color-surface)] shadow-[0_24px_48px_-24px_rgb(200_71_45/_0.25)]"
    ...
    >
      <div
        ...
        style={{
          ...
          background: `radial-gradient(420px circle at ${glow.x}% ${glow.y}%, rgb(200 71 45 / 0.12), transparent 50%)`,
        }}
      />
      {plan.featured && (
