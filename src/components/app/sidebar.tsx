...
export function AppSidebar({
  ...
  return (
    <aside className="hidden md:flex shrink-0 w-[240px] flex-col border-r border-[color:var(--color-border)] bg-[color:var(--color-bg-2)] sticky top-0 h-[100dvh]">
      ...
      <Link
        href="/audit/new"
        className="btn-tactile mx-4 mt-5 inline-flex items-center justify-center gap-2 rounded-md bg-[color:var(--color-accent)] text-[color:var(--color-accent-fg)] px-4 py-2.5 font-mono text-[11px] tracking-[0.16em] uppercase shadow-[0_4px_14px_-4px_rgb(200_71_45/_0.4)]"
      >
